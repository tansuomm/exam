   ...
   /*  $(document).ready(function(){
    	...
    	$("#selorgan").change(function(){
    		$.ajax({
    			...
    			type:"post",
    			url:"tk_findByorganId",
    			data:"organId="+$("#selorgan").val(),
...
<body class="mainbody">
<form name="form1" method="post" action="organ_update" id="form1">
    ...
    <div class="tab_con" style="display:block;">
      <table class="form_table">
        ...
        <tbody>
          ...
          <tr>
            <th>班级名称：</th>
            <td><input name="organName" value="${organ.organName}"  type="text" id="txtorganName" class="txtInput normal required" />
              	<input  name="organId" type="hidden" value="${organ.organId }"/> 
              <label>*</label></td>
          </tr>
          <tr>
            <th></th>
