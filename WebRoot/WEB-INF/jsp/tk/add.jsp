...
<body class="mainbody">
<form name="form1" method="post" action="tk_add" id="form1">
<input  name="tkjId" type="hidden" />
  <div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 控制面板 &gt; 添加题库</div>
  <div id="contentTab">
    <ul class="tab_nav">
      <li class="selected"><a onclick="tabs('#contentTab',0);" href="javascript:;">编辑题库</a></li>
    </ul>
    <div class="tab_con" style="display:block;">
      <table class="form_table">
        ...
        <tbody>
          ...
          <tr>
            <th>题库名称：</th>
            <td><input name="tkName"  type="text" id="txtscore" class="txtInput normal required" />
              <label>*</label></td>
          </tr>
