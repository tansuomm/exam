      ...
      <table class="form_table">
        ...
        <tbody>
          ...
          <tr>
            <th>题库：</th>
            <td>
              <select name="tm.tk.tkId" id="selTk" disabled>
          ...
          <tr>
            <th>题目名称：</th>
            <td><input name="tm.tmName" type="text" id="txt####" class="txtInput normal required" />
              <label>*</label></td>
          </tr>
          <tr>
            <th>题目分数：</th>
            <td><input name="tm.tmScore" type="text" id="txtContent" class="txtInput normal" />
              <label></label></td>
          </tr>
          <tr>
            <th>题目知识点：</th>
            <td><input name="tm.tmZsd" type="text" id="txtLinkUrl" class="txtInput normal required" />
              <label>*</label></td>
          </tr>
          <tr>
            <th>题目难度：</th>
            <td><input name="tm.tmNd" type="text" id="txtLogo" class="txtInput normal" /></td>
          </tr>
          <tr>
            <th></th>
