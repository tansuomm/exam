...
function GraphControl(h, w) {
   this.init(h, w);
   this.eqn = new Array();    // NOTE: graphs can handle multiple equations
   this.colors = new Array(); // Each graph line can be a specific color
   this.hatches = new Array(); // Each line can be filled using angled hatches
