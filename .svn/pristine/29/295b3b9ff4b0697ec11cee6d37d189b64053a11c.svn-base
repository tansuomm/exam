...
<head id="Head1"><link href="<%=path%>/App_Themes/Default_Admin/public.css" type="text/css" rel="stylesheet" /><title>
    ...
    <style type="text/css">
        ...
        .btn_Group{text-align:center;margin-top:0px;}
...
<form name="form1" method="post" action="tkcl_add" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
<div>
...
<script src="/WebResource.axd?d=K1T1k6_SvQNsqIbaADWrIyiSxyPSS2aUxFlCsm0c_zCJS4DHX-Bn_3L--Y0Ib1aC8pEEbMZDUpY48wZKLhdhGRQAf7A1&amp;t=635588912026805809" type="text/javascript"></script>


<script src="/ScriptResource.axd?d=8XX2xW3hjK3syPgw5CG839kyg7pNDZN7KKEEvDKGX2mw6rdyY_K1AV4KpYwqB8RQL0T-pyeOXrJONcng_zYsjgdInS8WzGeDs5rI0s9UICyBBH7CZgo4BDUtRDAqtnsXwxRAOJ4AcGmBo98GW17Mjc3oOh01&amp;t=635588912026805809" type="text/javascript"></script>
<script src="/ScriptResource.axd?d=U7S7sh_NK1FPSLOjv12L6jBtl5XJQAW5Tw0rDSQTabtQHuo8qXu1L6Tspqo0QkvQ8_qeDzvgcDlkw43dy4-Se-OkpSlW7L_3i4pYar0IKrRGQYEjHy1xUetEfRPuv3-2Dn5WPuVd3uZX21kaO4QexfbzZpIPyM4SK0sGq2A4ImVuSCqC0&amp;t=635963139320786431" type="text/javascript"></script>
<script src="/ScriptResource.axd?d=QflX79tfYIfGD4_Eo7R2KfHa_UuKNST_KDiOMz7r6Pk_7qa-TNSTjug0x8KjmVmkX7EC8RL3AHiV3mBHcBUZdEiJ84Nt9QUF2ON6tGVd6aIxMtjW7MwPBHVeC8Th40W0M8jTUcObYxBbK7WDPc6ArOOchDDB_Xn0p5b4h-hXoaq-ay2e0&amp;t=635963139320786431" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="796F32AD" />
</div>
        <script type="text/javascript">
//<![CDATA[
...
//]]>
        ...
        function InitExamTX(pageLoad)
        {
            ...
            if(tx!="")
            {
                ...
                {
                	//内容  是文本框
                    InsertCell(myNewRow,"<input type='text' readonly='readonly' style='width:20px;background-color:#FFFF80' id='stat_" + txidArr[i] + "'>","center",100);
                }
   	  		   ...
   	  		   success: function(msg){
   	  		     ...
   	  		     if($.trim(msg) != ""){
   	  		    	 ...
   	  		    	 $("#" + objid).attr("disabled", true);
   	  		 		 $("#" + objid).html("<option value='0'>=暂无题库=</option>");
   	  		     }
   	  		   }
   	  		});
        }
    		...
    		$.ajax({
   	  		   ...
   	  		   success: function(msg){
   	  		     ...
   	  		     if($.trim(msg) != ""){
   	  		    	 ...
   	  		    	 $("#" + objid).attr("disabled", true);
   	  		 		 $("#" + objid).html("<option value='暂无知识点'>=暂无知识点=</option>");
   	  		     }
   	  		   }
   	  		});
        }
        ...
        {
            var myObj = document.getElementById("PolicyTable").getElementsByTagName("INPUT");
        ...
        function PolicyAdd()
        {
    		...
    		$.ajax({
   	  		   ...
   	  		   //地址栏传值
   	  		   //题库集 题库 知识点 难度 题型
   	  		   data: "tkjid=" + $("#TKJList").val() + "&tkid=" + $("#TKList").val() + "&zsd=" + $("#ZSDList").val() + 
   	  		   "&nd=" + $("#NDList").val() + "&tx=" + $("#SelectedTX").val(),
   	  		   //成功
   	  		   success: function(msg){
   	  			  //返回字符串 
			 	  ...
			 	  //把字符串转成json格式
			 	 var json = eval("(" + msg + ")");
			 	 if(chkTk($("#TKJList option:selected").text(),$("#TKList option:selected").text(),$("#ZSDList option:selected").text())){
...
/*             var LocationUrl;
        ...
        function AddRow(json){
        	...
        	//题库
        	//通过Id找到题库的下拉框被选中找到文本
        	InsertCell(myNewRow,$("#TKList option:selected").text(),'center');
        	//知识点
        	InsertCell(myNewRow,$("#ZSDList option:selected").text(),'center');
        	//难度
        	InsertCell(myNewRow,$("#NDList option:selected").text(),'center');       	
            ...
            for(var i=0;i<txidArr.length;i++)
            {
            	...
            	//1,2,4
     		 	...
     		 	if(tempNum > -1){
     		 		...
     		 		InsertCell(myNewRow,"<input type='text' name='tm_num_" + jsonArr[tempNum].tmTxId + "' value='0' onmouseover='this.select()' onblur='CheckTMNum(this)' class='InputSolid' style='width:15px' > / <font color=\"red\">" + jsonArr[tempNum].tmTxNum + "</font>","center");
     		 	}
     		 	else{
     		 		InsertCell(myNewRow,"<input type='text' name='tm_num_" + txidArr[i] + "' value='0' onmouseover='this.select()' onblur='CheckTMNum(this)' class='InputSolid' style='width:15px' > / <font color=\"red\">0</font>","center");
     		 	}
     		 	
            }
		 	InsertCell(myNewRow,"<input type='hidden' name='clTkjId' value='" + $("#TKJList option:selected").val() + "'>" +
		 			"<input type='hidden' name='clTkId' value='" + $("#TKList option:selected").val() + "'>" + 
		 			"<input type='hidden' name='clZsd' value='" + $("#ZSDList option:selected").val() + "'>" + 
		 			"<input type='hidden' name='nd' value='" + $("#NDList option:selected").val() + "'>" + 
		 			"<input type='button' value='删除' class='two_button_w' onclick='DeleteRow(this)'>","center");
        }
        ...
        function SetTMTotalNum()
        {
            ...
            if(myTable.rows.length>0)
            {
                ...
                {
                    TXNumObj = document.getElementsByName("tm_num_" + TXArr[i]);
                    TXAccount = 0;
                    for(var j=0;j<TXNumObj.length;j++)
                    {
                        ...
                        if(ScoreType)
                        {
                            TotalScore += parseInt(document.getElementById("score_" + TXArr[i]).value) * TempNum;
                        }
                    }
                ...
                {
                    document.getElementById('TotalScore').value = document.getElementById('is_100').value;
                }
            }
        }
        ...
        function AdjustTMTXOrderKey()
        {
            ...
            for(var i=0;i<TMTXObj.length;i++)
            {
                ...
                {
                    k++;
                    document.getElementById("orderkey_" + TMTXObj[i].value).value = k.toString();
                }
            }
        }
        ...
        function CheckForm()
        {
            ...
            if(parseInt(document.getElementById('PassFS').value)>parseInt(document.getElementById('TotalScore').value))
            {
            ...
            {
                if(BTime.toLocaleDateString()!=ETime.toLocaleDateString())
                {
                    changeTabThree('1');
                    document.getElementById('valid_etime').select();
                    window.alert("当在考试计时选项中选择\"考试统一交卷\"的时候，试卷有效的日间段必段在一天内！");
                    DoStart();
                    return false;      
                }
            }
        ...
        function openwin()
        {
            ...
            FixSizeWin("ExamMessage.aspx?ClName=" + escape(text) +"&Stime=" + Stime + "&Etime=" + Etime,"message",500,255)
        }
                    ...
                    <tr>
                        <td>
                            <div id="tab">
                                ...
                                <div class="tab_off" id="tab2" onclick="changeTabThree('2');RedomTxSet();">
                                    高级设置
                                </div>
                                <div class="tab_off" id="tab3" onclick="changeTabThree('3');InitExamTX();">
                                    试卷策略
                                </div>
                                <div class="tabline" style="width: 387px;">
                                </div>
                                <div class="clear">
                                </div>
                            </div>
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td colspan="5" style="height: 26px" align="left">
                                                    <input name="tkClName" type="text" value="" id="txtTkClName" class="input" style="width:545px;" />
                                                    <select name="ExamCatalogList" id="ExamCatalogList" class="Select" style="width:100px;display: none;">
                                            ...
                                            <tr style="height: 26px;">
                                                <td style="text-align: left;" colspan="6">
                                                    <input id="rbGD" type="radio" name="SJLX" value="rbGD" checked="checked" onclick="gdSJ();" /><label for="rbGD">固定试卷 </label>
                                                    <span id="Label1">（所有的学员共用一套考题进行考试）</span></td>
                                            </tr>
                                            <tr style="height: 26px;">
                                                <td style="text-align: left;" colspan="6">
                                                    <input id="rbtnSJ" type="radio" name="SJLX" value="rbtnSJ" onclick="sjSJ();" /><label for="rbtnSJ">随机试卷</label>
                                                    <input name="SuitNumber" type="text" value="1" id="SuitNumber" disabled="disabled" class="input" onPaste="return false;" style="width:41px;" />套（学员从多套题中随机取一套进行考试）</td>
                                            </tr>
                                            <tr>
                                                <td height="26" colspan="2" style="text-align: right;">
                                                    显示方式：</td>
                                                <td width="80">
                                                    <select name="ExamMode" id="ExamMode" class="Select">
	...
	<option value="2">一屏显示一种题型</option>
                                                ...
                                                <td width="270" style="text-align: left;">
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    最多考试次数：<input name="MaxKsNum" type="text" value="1" id="MaxKsNum" class="input" onPaste="return false;" style="width:35px;" />
                                                    <span id="RangeValidator1" style="color:Red;display:none;">请输入正确的数字</span></td>
                                                <td width="50" height="26" colspan="2">
                                                    &nbsp;</td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td valign="top" width="50%">
                                                    <fieldset style="height: 80px;">
                                                        <legend><font color="#325A8B">时间参数</font> </legend>
                                                        <table class="noGridTable">
                                                            <tr>
                                                                <td>
                                                                    有效开始时间</td>
                                                                <td>
                                                                    <input name="validBtime" type="text" value="${currentTime}" readonly="readonly" id="valid_btime" class="input" onfocus="new WdatePicker(this,'%Y-%M-%D %h:%m:%s',true)" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    有效终止时间</td>
                                                                <td>
                                                                    <input name="valid_etime" type="text" value="2019/4/15 14:51:59" readonly="readonly" id="valid_etime" class="input" onfocus="new WdatePicker(this,'%Y-%M-%D %h:%m:%s',true)" /></td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                                </td>
                                                <td>
                                                    <fieldset style="height: 80px;">
                                                        <legend><font color="#325A8B">考试计时选项</font> </legend>
                                                        <table class="noGridTable" style="margin-top: 5px;">
                                                            <tr>
                                                                <td>
                                                                    <span id="tk_cl_time" class="Radio"><input id="tk_cl_time_0" type="radio" name="tk_cl_time" value="0" onclick="AdjustOption('tk_cl_time_num',0);" /><label for="tk_cl_time_0">考试不计时</label><br /><input id="tk_cl_time_1" type="radio" name="tk_cl_time" value="-1" onclick="AdjustOption('tk_cl_time_num',0);" /><label for="tk_cl_time_1">统一交卷</label><br /><input id="tk_cl_time_2" type="radio" name="tk_cl_time" value="1" checked="checked" onclick="AdjustOption('tk_cl_time_num',1);" /><label for="tk_cl_time_2">答题时间</label></span>
                                                                    <input name="tk_cl_time_num" type="text" value="60" id="tk_cl_time_num" class="input" onPaste="return false;" style="width:40px;" />分钟<span id="RangeValidator3" style="color:Red;display:none;">请输入正确的数字</span></td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                                </td>
                                        ...
                                        <fieldset>
                                            <legend><font color="#325A8B">防舞弊</font> </legend>
                                            <table class="noGridTable">
                                                <tr>
                                                    <td>
                                                        <table width="300px" style="display: inline;">
                                                            <tr>
                                                                <td>
                                                                    <span class="CheckBox"><input id="IsOrder" type="checkbox" name="IsOrder" /><label for="IsOrder">考题显示顺序随机</label></span></td>
                                                                <td>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="CheckBox"><input id="IsRerow" type="checkbox" name="IsRerow" /><label for="IsRerow">选择题候选项随机</label></span></td>
                                                                <td>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="300px" style="display: inline;">
                                                            <tr>
                                                                <td>
                                                                    <span id="MoveOutTimes" class="Radio"><input id="MoveOutTimes_0" type="radio" name="MoveOutTimes" value="0" checked="checked" onclick="AdjustOption('MoveOutTimes_num',0);" /><label for="MoveOutTimes_0">不限制移出WEB考试页</label><br /><input id="MoveOutTimes_1" type="radio" name="MoveOutTimes" value="1" onclick="AdjustOption('MoveOutTimes_num',1);" /><label for="MoveOutTimes_1">移出考试页面达到</label></span>
                                                                    <input name="MoveOutTimes_num" type="text" value="5" id="MoveOutTimes_num" disabled="disabled" class="input" onPaste="return false;" style="width:40px;" />
                                                                    次判为舞弊并自动交卷<span id="RangeValidator2" style="color:Red;display:none;">请输入正确的数字</span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr style="display: none;">
                                                    <td>
                                                        <span class="CheckBox"><input id="AllowUpload" type="checkbox" name="AllowUpload" /><label for="AllowUpload">允许上传附件（禁止溢出页面失效）</label></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
                                        <fieldset style="height: 40px; padding: 0 10px; margin-top: 5px;">
                                            <legend><font color="#325A8B">试卷安全</font></legend>
                                            <div>
                                                &nbsp;&nbsp;<span class="CheckBox"><input id="IsShowFS" type="checkbox" name="IsShowFS" /><label for="IsShowFS">考试分数保密</label></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="CheckBox"><input id="AllowSeePaper" type="checkbox" name="AllowSeePaper" /><label for="AllowSeePaper">允许考生提交后查看答卷和答案</label></span></div>
                                        </fieldset>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <fieldset style="margin-top: 5px;">
                                                                    <legend>
                                                                        <label for="style_enable">
                                                                            <font color="#325A8B">答卷保存参数组</font>
                                                                        </label>
                                                                    </legend>
	...
	<tr>
		<td><input id="KsSavePaper_0" type="radio" name="KsSavePaper" value="0" /><label for="KsSavePaper_0">服务器不保存考生答卷：只记录考试成绩，不保存考生的题目和答案，可以减轻交卷对服务器的压力，但交卷后无法查卷，适合上千人的大规模的考试（不允许主观题）</label></td>
	</tr><tr>
		<td><input id="KsSavePaper_1" type="radio" name="KsSavePaper" value="1" checked="checked" /><label for="KsSavePaper_1">交卷时保存答卷：考试过程中不保存考生答卷，适合中等规模的正式考试（几百人）</label></td>
	</tr><tr>
		<td><input id="KsSavePaper_2" type="radio" name="KsSavePaper" value="2" /><label for="KsSavePaper_2">手工保存答卷：考试过程中允许考生手工保存答卷，允许中途退出考试，适合布置不计时的作业</label></td>
	</tr>
</table></td>
                                                                        </tr>
                                                                        <tr style="display: none;">
                                                                        ...
                                                                        <tr>
                                                                            <td height="26">
                                                                                &nbsp;<span class="CheckBox "><input id="EnableHand" type="checkbox" name="EnableHand" /><label for="EnableHand">手工保存答卷：考试过程中允许考生手工保存答卷，允许中途退出考试，适合布置不计时的作业</label></span></td>
                                                                            <td height="26">
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="display:none;">
                                                                            <td height="26">
                                                                                &nbsp;<span class="CheckBox "><input id="LocalCache" type="checkbox" name="LocalCache" /><label for="LocalCache">启用本地缓存功能：在考试机器中即时保存答卷，出错后可以恢复答卷（推荐）</label></span></td>
                                                                            <td height="26">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                ...
                                <div id="block2" style="display: none; width: 680px;" class="block">
                                    <div class="this_height" style="padding-top: 20px;">
                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width: 673px">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td height="140">
                                                                <table width="670px" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td>
                                                                            <fieldset>
                                                                                <legend>
                                                                                    <label for="style_enable">
                                                                                        <font color="#325A8B">考生及评卷人</font>
                                                                                    </label>
                                                                                </legend>
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
	...
	<tr>
		<td><input id="clerk_all_0" type="radio" name="clerk_all" value="1" checked="checked" /><label for="clerk_all_0">允许所有账户参加考试</label></td>
	</tr><tr>
		<td><input id="clerk_all_1" type="radio" name="clerk_all" value="0" /><label for="clerk_all_1">在考试控制台中安排考生考试</label></td>
	</tr>
</table></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                            ...
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr style="display: none;">
                                                                                                    <td height="26">
                                                                                                        领导查询：</td>
                                                                                                    <td height="26">
                                                                                                        <input name="LeadersName" type="text" value="系统管理员" readonly="readonly" id="LeadersName" class="input" style="width:500px;" />
                                                                                                        <input type="hidden" name="LeadersID" id="LeadersID" value="1" />
                                                                                                        <input type="button" name="ClerkDialog1" class="two_button_w" value="选择" onclick="ClerkDialog('<%=path%>/','LeadersID','LeadersName',1);"></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td width="60" height="26">
                                                                                                        阅卷人员：</td>
                                                                                                    <td height="26" align="left">
                                                                                                        <input name="ManagersName" type="text" value="系统管理员" readonly="readonly" id="ManagersName" class="input" style="width:480px;" />
                                                                                                        <input type="hidden" name="ManagersID" id="ManagersID" value="1" />
                                                                                                        <input type="button" name="ClerkDialog2" value="选择" class="two_button_w" onclick="ClerkDialog('<%=path%>/','ManagersID','ManagersName',1);" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <fieldset>
                                                                    <legend>
                                                                        <label for="style_enable">
                                                                            <font color="#325A8B">题型与分数设置</font>
                                                                        </label>
                                                                    </legend>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="20" height="40">
                                                                                <input value="1" name="ScoreType" type="radio" id="ScoreType01" class="Radio" checked="checked" /></td>
                                                                            <td height="40">
                                                                                <label for="ScoreType01">
                                                                                    使用题库中试题的分数，并将总分折算为 总分</label>
                                                                                <input name="is_100" type="text" value="100" id="is_100" class="input" style="width: 40px" /></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="20" height="26">
                                                                                <input value="0" name="ScoreType" type="radio" id="ScoreType02" class="Radio" /></td>
                                                                            <td height="26">
                                                                                <label for="ScoreType02">
                                                                        ...
                                                                        function RedomTxSet()
                                                                        {
                                                                            var chkname = document.getElementsByName("Tm_tx_ID");
                                                                        ...
                                                                        //-->
                                                                                ...
                                                                                <div style="height: 200px; width: 640px; position: absolute; overflow: auto; scrollbar-face-color: #D4D0C8;
                                                                                    ...
                                                                                    <div>
	<table class="tab_table" cellspacing="0" cellpadding="1" rules="all" border="1" id="ExamTXGridView" style="width:640px;border-collapse:collapse;">
		<tr class="tab_label">
			<th scope="col">
                                                                                                    <input id="tmtx_all" type="checkbox" class="CheckBox" onclick="CheckAll(this,'ExamTXGridView')"
                                                                                                        title="全部选定/全部取消" />
                                                                                                </th><th scope="col">题型标题</th><th scope="col">分数</th><th scope="col">说明</th><th scope="col">顺序号</th>
		</tr><tr class="tab_tr1">
																								<td align="center" style="width:30px;">
                                                                                                    <input type="checkbox" name="Tm_tx_ID" class="CheckBox" id='tmtxid_1' value='1' title='0' />
                                                                                                </td><td style="width:100px;">单选题</td><td align="center" style="width:100px;">
                                                                                                    <input type="text" style="width: 40px" name='score_1' class="input" id='score_1' value='1' />
                                                                                                </td><td style="width:300px;">
                                                                                                    <textarea type="text" style="width: 97%" name='notes_1' class="input" id='notes_1'>单选题</textarea>
                                                                                                </td><td align="center">
                                                                                                    <input type="text" style="width: 40px" name='orderkey_1' class="input" id='orderkey_1' value='0' />
                                                                                                </td>
		</tr><tr class="tr_al">
			<td align="center" style="width:30px;">
                                                                                                    <input type="checkbox" name="Tm_tx_ID" class="CheckBox" id='tmtxid_2'
                                                                                                        value='2' title='1' />
                                                                                                </td><td style="width:100px;">填空题</td><td align="center" style="width:100px;">
                                                                                                    <input type="text" style="width: 40px" name='score_2' class="input"
                                                                                                        id='score_2' value='1' />
                                                                                                </td><td style="width:300px;">
                                                                                                    <textarea type="text" style="width: 97%" name='notes_2' class="input"
                                                                                                        id='notes_2'>填空题</textarea>
                                                                                                </td><td align="center">
                                                                                                    <input type="text" style="width: 40px" name='orderkey_2' class="input"
                                                                                                        id='orderkey_2' value='1' />
                                                                                                </td>
		</tr><tr class="tab_tr1">
			<td align="center" style="width:30px;">
                                                                                                    <input type="checkbox" name="Tm_tx_ID" class="CheckBox" id='tmtxid_3'
                                                                                                        value='3' title='2' />
                                                                                                </td><td style="width:100px;">多选题</td><td align="center" style="width:100px;">
                                                                                                    <input type="text" style="width: 40px" name='score_3' class="input"
                                                                                                        id='score_3' value='2' />
                                                                                                </td><td style="width:300px;">
                                                                                                    <textarea type="text" style="width: 97%" name='notes_3' class="input"
                                                                                                        id='notes_3'>多选题</textarea>
                                                                                                </td><td align="center">
                                                                                                    <input type="text" style="width: 40px" name='orderkey_3' class="input"
                                                                                                        id='orderkey_3' value='2' />
                                                                                                </td>
		</tr><tr class="tr_al">
			<td align="center" style="width:30px;">
                                                                                                    <input type="checkbox" name="Tm_tx_ID" class="CheckBox" id='tmtxid_4'
                                                                                                        value='4' title='3' />
                                                                                                </td><td style="width:100px;">判断题</td><td align="center" style="width:100px;">
                                                                                                    <input type="text" style="width: 40px" name='score_4' class="input"
                                                                                                        id='score_4' value='1' />
                                                                                                </td><td style="width:300px;">
                                                                                                    <textarea type="text" style="width: 97%" name='notes_4' class="input"
                                                                                                        id='notes_4'>填空题</textarea>
                                                                                                </td><td align="center">
                                                                                                    <input type="text" style="width: 40px" name='orderkey_4' class="input"
                                                                                                        id='orderkey_4' value='3' />
                                                                                                </td>
		</tr><tr class="tab_tr1">
			<td align="center" style="width:30px;">
                                                                                                    <input type="checkbox" name="Tm_tx_ID" class="CheckBox" id='tmtxid_5'
                                                                                                        value='5' title='4' />
                                                                                                </td><td style="width:100px;">问答题</td><td align="center" style="width:100px;">
                                                                                                    <input type="text" style="width: 40px" name='score_5' class="input"
                                                                                                        id='score_5' value='3' />
                                                                                                </td><td style="width:300px;">
                                                                                                    <textarea type="text" style="width: 97%" name='notes_5' class="input"
                                                                                                        id='notes_5'>问答题</textarea>
                                                                                                </td><td align="center">
                                                                                                    <input type="text" style="width: 40px" name='orderkey_5' class="input"
                                                                                                        id='orderkey_5' value='4' />
                                                                                                </td>
		</tr>
	</table>
</div>
                                    ...
                                    <div class="this_height" style="padding-top: 5px;">
                                        <table height="30" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    题库集：&nbsp;
				<s:select list="#request.tkjList" name="TKJList" id="TKJList" onchange="GetTKList(this.value);GetZSDList($('#TKJList').val(),0);"
				headerKey="-1" headerValue="=请选择=" listKey="tkjId" listValue="tkjName" theme="simple"></s:select>
				
                                                    题库：&nbsp;
               <select name="TKList" id="TKList" class="Select" onchange="GetZSDList($('#TKJList').val(),this.value);" style="width:120px;">
					<option value="0">所有</option>
			   </select>
                                                    知识点：&nbsp;<select name="ZSDList" id="ZSDList" class="Select" style="width:100px;">
	...
	<option value="5">5</option>
                                                    ...
                                                    <input type="button" id="PolicyAddButton" class="four_button" style="display: inline;"
                                                        value="增加" onclick="PolicyAdd()"><input type="button" id="PolicyModifyButton" class="four_button"
                                                            style="display: none;" value="修改策略" onclick="PolicyModify()">
                                                </td>
                                            </tr>
                                        </table>
                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <fieldset>
                                                                                <legend>
                                                                                    <label for="style_enable">
                                                                                        <font color="#325A8B">试题策略</font>
                                                                                    </label>
                                                                                </legend>
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td height="292">
                                                                                            <div style="height: 292px; width: 650px; position: absolute; overflow: auto; scrollbar-face-color: #D4D0C8;
                                                                                                scrollbar-highlight-color: #ffffff; scrollbar-shadow-color: #ffffff; scrollbar-3dlight-color: #666666;
                                                                                                scrollbar-arrow-color: #216dad;">
                                                                                                <table id="PolicyTable" border="0" cellpadding="1" cellspacing="0" class="tab_table"
                                                                                                    style="width: 650px">
                                                                                                </table>
                                                                                            </div>
                                                                                        </td>
                                                                    ...
                                                                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td width="80" height="40">
                                                                                题目总数：</td>
                                                                            <td height="40">
                                                                                <input type="text" style="width: 60px" id="TotalAccount" class="input" readonly="readonly"
                                                                                    value="0" /></td>
                                                                            <td width="60">
                                                                                总分：</td>
                                                                            <td>
                                                                                <input name="TotalScore" type="text" id="TotalScore" style="width: 60px" class="input" readonly="readonly" /></td>
                                                                            <td width="60">
                                                                                及格分：</td>
                                                                            <td>
                                                                                <input name="PassFS" type="text" value="60" id="PassFS" class="input" onpaste="return false;" style="width:60px;" /><span id="RangeValidator5" style="color:Red;display:none;">请输入正确的数字</span>
                                                                                <input type="hidden" name="PolicyFlag" class="input" id="PolicyFlag" value="0" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <div class="clear">
                ...
                function chkname()
                {
                    document.getElementById("chknameiframe").src = "chknameiframe.ashx?ExamName=" + escape(document.getElementById('tk_cl_name').value) + "&ExamID=" + '';
                }
                function gdSJ()
                {
                ...
                <div class="btnsubmit">
                    <input type="button" value="上一页" style="display: none;" id="btn_pro" class="four_button_y"
                        onclick="changeTabThree('1');" />
                    <input type="button" value="上一页" style="display: none;" id="btn_pro1" class="four_button_y"
                        onclick="changeTabThree('2');" />
                    <input type="button" value="下一页" id="btn_next" class="four_button_y" onclick="changeTabThree('2');RedomTxSet();" />
                    <input type="button" value="下一页" style="display: none;" id="btn_next1" class="four_button_y"
                    ...
                    <input type="submit" name="Submit" value="确 定" id="Submit" class="four_button_y" style="display: block;" />
                    <input type="button" value="取 消" id="btn_Cancel" class="four_button_y" onclick="if(confirm('确认不保存修改内容就退出吗？')){window.close();}" />
                </div>
            </div>
        </div>
...
<script type="text/javascript">
//<![CDATA[
var Page_Validators =  new Array(document.getElementById("RangeValidator1"), document.getElementById("RangeValidator3"), document.getElementById("RangeValidator2"), document.getElementById("RangeValidator4"), document.getElementById("RangeValidator5"));
//]]>
</script>
...
<script language='javascript'>GetTKList($get('TKJList').value);</script>
<script type="text/javascript">
//<![CDATA[
